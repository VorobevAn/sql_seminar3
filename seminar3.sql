...
-- 1.вывод таблицы в следующем порядке: city, sname, snum, comm. 
...
(id int, name varchar(100), surname varchar(100), specialty varchar(100), seniority int, salary int, age int);
